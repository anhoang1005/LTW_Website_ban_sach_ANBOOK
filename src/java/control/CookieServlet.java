 ...
 * @author Hoang Van An
 */
@WebServlet(name="CookieServlet", urlPatterns={"/cartcookie"})
    ...
    throws ServletException, IOException {
        ...
        if(action.equals("add")){
            ...
            if(cookies == null){
                ...
                Cookie cookie = new Cookie("cartcookie", cartJSON);
                ...
                if (cartString != null) {
                    ...
                    Gson gson = new Gson();
                    List<Cart> cart = gson.fromJson(cartString, new TypeToken<List<Cart>>() {}.getType());
                    Cart c = new Cart(bdao.getBookDetail(bookid), quantity);
                    cart.add(c);
                    String cartJSON = gson.toJson(cart);
                    Cookie cookie = new Cookie("cartcookie", cartJSON);
