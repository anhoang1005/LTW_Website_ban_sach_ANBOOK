                            ...
                            <tbody>
                                <c:forEach var="book" items="${listBook}">
                                    <tr>
                                        ...
                                        <th class="text-center font-weight-normal">SP0${book.bookid}</th>
                                        <th style="width: 5%" class="text-center">
                                            <img style="width: 100%; height: auto" src="${book.image}" alt="alt"/>
                                        </th>
                                        <th class="text-center font-weight-normal">${book.title}</th>
                                        <th class="text-center font-weight-normal">${book.catename}</th>
                                        <th class="text-center font-weight-normal">${book.authorname}</th>
                                        <th class="text-center font-weight-normal">${book.publishername}</th>
                                        <th class="text-center font-weight-normal">${book.price}</th>
                                        <th class="text-center font-weight-normal">${book.soldcount}</th>
                                        <th class="text-center font-weight-normal">${book.quantity}</th>
